<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::select('position', $positions, null, ['class' => 'form-control', 'placeholder' => 'เลือกตำแหน่ง']) }}
    </div>


    <div class="form-group col-md-6">
        {{ Form::label('department', 'แผนก:') }}
        {{ Form::select('department', $departments, null, ['class' => 'form-control', 'placeholder' => 'เลือกแผนก']) }}
    </div>
